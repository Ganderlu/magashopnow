...
export function PromoBar() {
  ...
  return (
    <div className="w-full bg-[linear-gradient(90deg,#2a0000_0%,#5a0000_50%,#2a0000_100%)] text-[11px] font-semibold tracking-wide text-zinc-100">
      <div className="mx-auto flex h-8 max-w-[1240px] items-center justify-between px-4 sm:px-6">
