            ...
            <div className="relative w-full sm:hidden">
              <div className="mx-auto max-w-[520px]">
                <div className="flex items-center justify-center gap-3 pb-4">
                  <div className="grid h-12 w-12 place-items-center rounded-2xl bg-[radial-gradient(circle_at_30%_30%,#ff9b3a_0%,#3bd16f_55%,#1b6bd6_100%)] text-[16px] font-extrabold text-white shadow-[0_10px_30px_rgba(0,0,0,0.35)]">
                    47
                  </div>
                  <div className="text-center leading-tight">
                    <div className="text-[12px] font-extrabold tracking-wide text-[#f2c44e]">
                      ASSET BACKED
                    </div>
                    <div className="text-[20px] font-extrabold tracking-wide text-white">
                      RAINBOW BILLS
                    </div>
                  </div>
                </div>
                ...
                <div className="grid gap-3">
                  <div className="grid grid-cols-2 gap-3">
                    <div className="flex items-center justify-between rounded-full border border-white/10 bg-black/35 px-4 py-3">
                      <div className="text-[11px] font-extrabold tracking-wide text-white/65">
                        BUNDLE PRICE
                      </div>
                      <div className="text-[14px] font-extrabold text-white">
                        {promo?.bundlePrice ?? "$3,499"}
                    ...
                    <div className="flex items-center justify-center gap-2 rounded-full border border-emerald-400/25 bg-[radial-gradient(110%_140%_at_0%_0%,rgba(46,232,126,0.22)_0%,rgba(0,0,0,0)_55%)] px-4 py-3">
                      <TrendUpIcon className="h-4 w-4 text-emerald-300" />
                      <div className="text-[14px] font-extrabold text-emerald-300">
                        {promo?.profitDelta ?? "+$49,750"}
                      </div>
                  ...
                  <div className="flex items-center justify-center gap-3 rounded-full border border-red-400/30 bg-black/35 px-4 py-3">
                    <div className="h-2 w-2 rounded-full bg-red-500 shadow-[0_0_0_3px_rgba(255,0,0,0.15)]" />
                    <div className="text-[14px] font-extrabold text-white">
                      {promo?.setsLeftLabel ?? "14 Sets Left"}
                    </div>
